...
$mail->Username = 'developer012025@gmail.com';          // SMTP username
$mail->Password = 'glgs deyd rtgs kosb'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom('karthiga.official14@gmail.com', 'Your_Name');
$mail->addReplyTo('karthiga.official14@gmail.com', 'Your_Name');
